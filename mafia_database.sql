...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: Ne 02.Dec 2018, 17:17
...
(3, 'Smrteľné sesterstvo', '2018-12-02');
...
CREATE TABLE `clen` (
  ...
  `familia` varchar(255) COLLATE utf8_czech_ci DEFAULT NULL,
...
('8660138509', 'Reynosa Cartel', 'N 26°3.88785, W 98°17.80297', 3, 2),
('9754034862', 'Monique Cartel', 'N 36°0.84342, E 14°19.46250', 3, NULL),
('9854032958', 'Dianne Cartel', 'N 48°34.63458, E 19°7.55460', 3, NULL);
...
--
ALTER TABLE `aliancia`
  MODIFY `id_aliancie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
